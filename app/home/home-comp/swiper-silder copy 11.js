...
// const movedItems = index - prevIndex.current;
  ...
  g.onChange((e) => {
    ...
    // ✅ REAL Tinder direction
    swipeDirection.value = e.translationX > 0 ? "right" : "left";
...
onSnapToItem={(index) => {
  ...
  console.log("Items moved:", isAutoScrolling);
  if (!direction) return;

  if (direction === "right") {
  isAutoScrolling.current = true;

  const nextIndex = prevIndex.current + 1;

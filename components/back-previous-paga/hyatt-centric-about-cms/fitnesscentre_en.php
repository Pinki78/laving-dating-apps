...
<meta charset="utf-8">
<link rel="preload" as="image" href="images/en-fitnessbg.jpg">
<script type="text/javascript" src="js/preloadimages.js">
preload([
	"images/menu.png",
	"images/menu-active.png",
	"images/menu-cover.png",
	"images/en-fitnessbg.jpg",
	"images/en-swimming.jpg",
...
<style>
body {
    background-image   : url(images/en-fitnessbg.jpg);
...
<div id="dock-container">
  ...
  <div id="dock">
    <div class="backurl" content-type="url" single_click_url="abouthotellanding_en.php?menu=menu5&stb-type=<?php echo $_GET['stb-type'] ?>&browser-version=<?php echo $_GET['browser-version']?>"></div>
    <ul id="main_menu_ul" style="cursor:pointer;">
      <li id="1" select="true"><span>Fitness Centre & Swimming Pool</span>
        <div content-type="image" single_click_url="en-swimming.jpg" item="menu1"><img src="images/swimming_menu.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li>

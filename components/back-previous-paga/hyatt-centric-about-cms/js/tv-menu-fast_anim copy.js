  ...
  if (
    ...
    if (!isFirstScroll) {
      ...
      if (thresholdValue > menus_to_be_displayed) {
        tmp_left = (235 * (hidden_menus + menus_to_be_hiden_onscroll));
        ...
        if (tmp_menus_to_be_hidden_onscroll > 0) {
          ...
          if (menuItemCount == 7) {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 132;
          }else if (menuItemCount == 5) {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 175;
          } else if (menuItemCount == 6) {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 155;
          } else if (menuItemCount == 9) {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 90;
          }else if (menuItemCount == 12) {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 18;
          } else {
            tmp_left = (235 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) ;
          }
      ...
      tmp_left = (235 * cnt_menus_to_be_hidden_onscroll) - 175;
...
function startRightScroll(current_selected_menu) {
  if (
    ...
    if (hidden_menus_steps_array.length > 0) {
      ...
      tmp_left = (235 * (hidden_menus - tmp_pop));
      menu_transition_started = true;
      $("#main_menu_ul").animate(
        { left: "-" + tmp_left + "px" },
        1,

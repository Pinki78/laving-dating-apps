...
$(document).ready(function () {
  ...
  if (tot_menus < menus_to_be_displayed) {
    $("#main_menu_ul").css({ display: "inline-block", position: "static",outline: "none" });
  }
  if (tot_menus > menus_to_be_displayed) {
    tot_menus += 2;
  }
  $("#dock").css({ outline: "none"});
...
function startLeftScroll(current_selected_menu, isFirstScroll) {
  if (
    getMenuIndexByMenuElement(current_selected_menu) ==
      hidden_menus + menus_to_be_displayed || //for left scroll
    isFirstScroll
  ) {
    var tmp_left = 0;
    var transition = 1;
    if (!isFirstScroll) {
      ...
      if (thresholdValue > menus_to_be_displayed) {
        ...
        if (tmp_menus_to_be_hidden_onscroll > 0) {
          ...
          // if (menuItemCount == 7) {
          //   tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 132;
          // }else if (menuItemCount == 5) {
          //   tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 175;
          // } else if (menuItemCount == 6) {
          //   tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 155;
          // } else if (menuItemCount == 9) {
          //   tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 90;
          // }else if (menuItemCount == 12) {
          //   tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) - 18;
          // } else {
...
tmp_left = (245 * (hidden_menus + tmp_menus_to_be_hidden_onscroll)) ;
  ...
  if (tmp_left > maxScrollLeft) {
    tmp_left = maxScrollLeft;
      ...
      tmp_left = (245 * cnt_menus_to_be_hidden_onscroll) - 175;
...
function startRightScroll(current_selected_menu) {
  if (
    getMenuIndexByMenuElement(current_selected_menu) == hidden_menus - 1 &&
    hidden_menus > 0
  ) {
    //for right scroll

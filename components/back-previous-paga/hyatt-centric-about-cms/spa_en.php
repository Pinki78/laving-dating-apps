...
<meta charset="utf-8">
<link rel="preload" as="image" href="images/en-spabg.jpg">
...
preload([
	...
	"images/en-spabg.jpg",
	"images/en-thespa.jpg",
	"images/thespa_menu.png",
...
<style>
body {
    background-image   : url(images/en-spabg.jpg);
...
<div id="dock-container">
  ...
  <div id="dock">
    <div class="backurl" content-type="url" single_click_url="abouthotellanding_en.php?menu=menu4&stb-type=<?php echo $_GET['stb-type'] ?>&browser-version=<?php echo $_GET['browser-version']?>"></div>
    <ul id="main_menu_ul" style="cursor:pointer;">
      <li id="1" select="true"><span>The Spa</span>
        <div content-type="image" single_click_url="en-thespa.jpg" item="menu1"><img src="images/thespa_menu.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li>
